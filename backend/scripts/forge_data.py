    ...
    try:
        ...
        for rule in med_knowledge.get('rules', []):
            ...
            if 'target_substance' in rule:
                ...
                # Chercher dans les substances importées (qui ont le nom exact)
                # Comme la clé du dict substance_ids est le nom officiel (souvent avec sel), il vaut mieux
                # chercher une substance dont le nom normalisé matche
